...
<body>
    ...
    <div class="container">
        ...
        <div class="editor-container editor-modify" id="modify-editor" onclick="goToUrl('store.php')"></div>
        <div>
            <?php
                include "db_conn.php";
                $name = $_GET['name'];
                ...
                if ($stmt = $db->query($query)) {
                    ...
                    echo "<form class='editor modify-editor-form' id='modify-editor-form' method='POST' action='store_mdysave.php?name='".$result->name.">";
                    ...
                    echo "<input class='add-editor-input add-name-input' type='text' name='phone_number' value='".$result->phone_number."'>";
            ...
            <div class="add-editor-buttons">
                <input class="add-editor-submit-button" type="submit" value="新增">
                <button class="add-editor-cancel-button" onclick="goToUrl('store.php')">取消</button>
            </div>
        </div>
        <div class="content">
                ...
                <?php
                    ...
                    if ($stmt = $db->query($query)) {
                        while ($result = mysqli_fetch_object($stmt)) {
                            ...
                            echo '</form>';
                            echo "<form class='table-option-form' method='POST' action='store.php?name='".$result->name."'>";
                            ...
                            echo '</svg>';
                            echo '<input class="table-option-submit-button" type="submit" value="修改" onclick="handleModifyInputFieldOnOpen()">';
                            echo '</form>';
                            echo '</td>';
                            echo "</tr>";
                        }
