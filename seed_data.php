...
// 插入店家資料
$stores = [
    ['PChome', '02-12345678', '台北市信義區松高路18號'],
    ['Shopee', '02-23456789', '台北市中正區忠孝西路1段47號'],
    ['Amazon', '02-34567890', '台中市南屯區文心路一段100號'],
    ['Costco', '02-45678901', '高雄市左營區博愛二路777號'],
    ['IKEA', '02-56789012', '台北市大安區敦化南路1段221號'],
    ['Pazzion', '02-67890123', '新北市永和區永貞路15號'],
    ['Yahoo Shopping', '02-78901234', '台北市內湖區民權東路六段15號'],
    ['Walmart', '02-89012345', '高雄市前鎮區中華五路100號'],
    ['Best Buy', '02-90123456', '新北市板橋區中山路1段152號'],
];
...
foreach ($clothStyles as $style) {
    $sql = "INSERT INTO `clothstyle` (`id`, `name`, `description`) 
...
foreach ($clothStylesMapping as $mapping) {
    $sql = "INSERT INTO `clothestoclothstyles` (`cloth_id`, `cloth_style_id`) 
