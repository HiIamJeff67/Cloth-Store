    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <?php
                include "db_conn.php";
                $id = $_GET['id'];
                $query = ("Select * From drinkrecipe where drid =".$id);
                if($stmt = $db->query($query)){
                    $result=mysqli_fetch_object($stmt);
                    echo "<form form action=drink_recipe_mdysave.php?id=".$result->drId." method=POST>";
                    echo "<br/>調酒編號: ".$result->drId."<br>";
                    echo "調酒名稱: <input type=text name =name value=".$result->drName."><br>";
                    echo "調酒描述: <input type=text name =description value=".$result->drDescription."><br>";
                    ...
                    echo "<br><input type=submit value=更改></form>";
                }  
            ?>
            </div>
        </div>
