    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <?php
                include "db_conn.php";
                $id = $_GET['id'];
                $query = ("Select * From drink where did =".$id);
                if($stmt = $db->query($query)){
                    $result=mysqli_fetch_object($stmt);
                    echo "<form form action=drink_mdysave.php?id=".$result->dId." method=POST>";
                    echo "<br>酒類編號: ".$result->dId."<br>";
                    echo "酒類名稱: <input type=text name=name value=".$result->dName."><br>";
                    echo "酒類描述: <input type=text name=description value=".$result->dDescription."><br>";
                    echo "酒類價錢: <input type=number name=price value=".$result->dPrice."><br>";
                    echo "商家名稱: ";
