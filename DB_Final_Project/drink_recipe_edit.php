    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <div class="col-sm-10">
                ...
                <?php
                    ...
                    if($stmt = $db->query($query)){
                        ...
                        while($result=mysqli_fetch_object($stmt)){
                            ...
                            echo '<td align="center"><form  method="POST" action="drink_recipe_del.php?id=' . $result->drId . '"><input type="submit" value="刪除"></form></td>';
                            echo '<td align="center"><form  method="POST" action="drink_recipe_mdy.php?id=' . $result->drId . '"><input type="submit" value="修改"></form></td>';
                            echo "</tr>";
                        }
                        echo "</table>";
                    }
                ...
                <form action="drink_recipe_add.php" method="POST">
                <br>
                調酒編號: <input type="text" name="id">
                <br>
                調酒名稱: <input type="text" name="name">
                <br>
                調酒描述: <input type="text" name="description">   
                <br>
                <?php
                    include "db_conn.php";
                    $query2 = ("Select * From drink");
                    if($stmt2 = $db->query($query2)){
                        while($result2=mysqli_fetch_object($stmt2)){
                            echo "<label>";
                            echo "<input type=checkbox name=drink[] value= ".$result2->dId.">";
                            echo  $result2->dName."</label>";
