            ...
            <div class="col-sm-10">
                <?php
                    ...
                    if($stmt = $db->query($query)){
                        ...
                        echo "<br>商店名稱:".$result->stName."<br>";
                        echo "<form form action=store_mdysave.php?stName=".$result->stName." method=POST>";
                        echo "商店電話: <input type=text name=stPhone value=".$result->stPhone."><br>";
                        echo "營業時間: <input type=text name=stWorkTime value=".$result->stWorkTime."><br>";
                        echo "商店地址: <input type=text name=stAddress value=".$result->stAddress."><br>";
