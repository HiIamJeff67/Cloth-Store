    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <br/>
                ...
                <tr>
                <th><span style="color: white;">商店名稱</th>
                <th><span style="color: white;">商店電話</th>
                <th><span style="color: white;">營業時間</th>
                <th><span style="color: white;">商店地址</th>
                </tr>
                </table>
                <?php
                    include "db_conn.php";
                    ...
                    if($stmt = $db->query($query)){
                        ...
                        while($result=mysqli_fetch_object($stmt)){
                            ...
                            echo '<td align="center"><form  method="POST" action="store_del.php?stName=' . $result->stName . '"><input type="submit" value="刪除"></form></td>';
                            echo '<td align="center"><form  method="POST" action="store_mdy.php?stName=' . $result->stName . '"><input type="submit" value="修改"></form></td>';
                            echo "</tr>";
                        }
                        echo "</table>";
                    }
                ...
                <br>
                商店名稱: <input type="text" name="stName">
                <br>
                商店電話: <input type="text" name="stPhone">
                <br>
                營業時間: <input type="text" name="stWorkTime">   
                <br>
                商店地址: <input type="text" name="stAddress">   
                <br>
