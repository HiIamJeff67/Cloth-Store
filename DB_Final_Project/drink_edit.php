                ...
                <?php
                    ...
                    if($stmt = $db->query($query)){
                        ...
                        while($result=mysqli_fetch_object($stmt)){
                            ...
                            echo '<td align="center"><form  method="POST" action="drink_del.php?id=' . $result->dId . '"><input type="submit" value="刪除"></form></td>';
                            echo '<td align="center"><form  method="POST" action="drink_mdy.php?id=' . $result->dId . '"><input type="submit" value="修改"></form></td>';
                            echo "</tr>";
                        }
                        echo "</table>";
                    }
                ?>
                <form action="drink_add.php" method="POST">
                    <br>
                    酒類編號: <input type="text" name="id">
                    <br>
                    酒類名稱: <input type="text" name="name">
                    <br>
                    酒類描述: <input type="text" name="description">
                    <br>
                    酒類價錢: <input type="number" name="price">   
                    <br>
                    商家名稱: 
                    <select name=stName>
                        <?php
                            ...
                            if($stmt2 = $db->query($query2)){
                                while($result2=mysqli_fetch_object($stmt2)){
                                    echo "<option value=".$result2->stName.">".$result2->stName."</option>";
                                }
                        ...
                        <?php
                            ...
                            if($stmt3 = $db->query($query3)){
                                while($result3=mysqli_fetch_object($stmt3)){
                                    echo "<option value=".$result3->spName.">".$result3->spName."</option>";
                                }
