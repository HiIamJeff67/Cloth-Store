...
<div class="col-sm-10">
    ...
    <table style="background-color: black;">
        <tr>
            <th><span style="color: white;">服裝編號</span></th>
            <th><span style="color: white;">服裝名稱</span></th>
            <th><span style="color: white;">服裝描述</span></th>
            <th><span style="color: white;">服裝價錢</span></th>
            <th><span style="color: white;">商家名稱</span></th>
    ...
    <?php
        ...
        if($stmt = $db->query($query)){
            ...
            while($result = mysqli_fetch_object($stmt)){
                ...
                echo '<td align="center"><form method="POST" action="clothing_info_mdy.php?id=' . $result->id . '"><input type="submit" value="修改"></form></td>';
                echo "</tr>";
            }
            echo "</table>";
        }
    ?>
    <form action="clothing_info_add.php" method="POST">
        <br>
        服裝編號: <input type="text" name="id">
        <br>
        服裝名稱: <input type="text" name="name">
        <br>
        服裝描述: <input type="text" name="description">
        <br>
        服裝價錢: <input type="number" name="price">   
        <br>
        商家名稱: 
            ...
            <?php
                ...
                if($stmt2 = $db->query($query2)){
                    while($result2 = mysqli_fetch_object($stmt2)){
                        echo "<option value=".$result2->store_name.">".$result2->store_name."</option>";
                    }
                }
            ?>
        </select>
            ...
            <?php
                ...
                if($stmt3 = $db->query($query3)){
                    while($result3 = mysqli_fetch_object($stmt3)){
                        echo "<option value=".$result3->supplier_name.">".$result3->supplier_name."</option>";
                    }
                }
            ?>
        </select>
