...
<body>
    ...
    <?php
        ...
        if($stmt = $db->query($query)){
            ...
            while($result = mysqli_fetch_object($stmt)){
                ...
                echo '<td align="center"><form  method="POST" action="clothing_style_del.php?id=' . $result->id . '"><input type="submit" value="刪除"></form></td>';
                echo '<td align="center"><form  method="POST" action="clothing_style_mdy.php?id=' . $result->id . '"><input type="submit" value="修改"></form></td>';
                echo "</tr>";
            }
            echo "</table>";
        }
    ...
    <form action="clothing_style_add.php" method="POST">
    <br>
    ...
    <?php
        ...
        if($stmt2 = $db->query($query2)){
            while($result2 = mysqli_fetch_object($stmt2)){
                echo "<label>";
                echo "<input type='checkbox' name='clothing[]' value='" . $result2->id . "'>";
                echo $result2->name . "</label>";
            }
        }
    ?>
    <br>
